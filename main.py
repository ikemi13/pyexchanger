...
class CurrencyConverter(ttk.Frame):
    ...
    def __init__(self, parent, **args):
        ...
        self.inCurrencyCombo = ttk.Combobox(
            self, width=25, height=5, values=currency_keys, textvariable=self.inCurrency)
        ...
        self.outCurrencyCombo = ttk.Combobox(
            self, width=25, height=5, values=currency_keys, textvariable=self.outCurrency)
